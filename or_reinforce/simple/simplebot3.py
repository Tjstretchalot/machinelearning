"""Simple Bot except instead of an 'arrow' pointing to the staircase, he just
gets his position and the staircases position"""
import os
import torch
import random
...
print(f'simplebot3 encode_dim = {ENCODE_DIM}')
...
def simplebot3(entity_iden: int) -> 'Bot':
